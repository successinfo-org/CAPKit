...
+(void)load{
    [WidgetMap bind: @"scrollview" withModelClassName: @"ScrollViewM" withWidgetClassName: @"ScrollViewWidget"];
}
...
- (void)closeDragDown{
    [OSUtils runBlockOnMain:^{
        [_refreshScrollView egoRefreshScrollViewDataSourceDidFinishedLoading: (UIScrollView *)view];
    }];
}
...
- (void)keyboardDidChangeFrame:(NSNotification *)notification{
    ...
    BOOL meet = NO;
    ViewWidget *parentWidget = [self.pageSandbox lastEditingFocus].parent;
    ...
    keyboardBounds = [ScrollViewWidget rectWithRotation: keyboardBounds];
    
    CGRect screenRect = [ScrollViewWidget rectWithRotation: [UIApplication sharedApplication].keyWindow.bounds];
    CGRect bounds = [self innerView].bounds;
    CGRect selfOnScreenRect = [ScrollViewWidget rectWithRotation: [[self innerView] convertRect: bounds toView: [UIApplication sharedApplication].keyWindow]];
